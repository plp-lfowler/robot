...
static const _Block_type_support_symbol_names_t _Block_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_cobot_interfaces, msg, Block)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_cobot_interfaces, msg, Block)),
  }
};
...
{
  return &::my_cobot_interfaces::msg::rosidl_typesupport_cpp::Block_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, my_cobot_interfaces, msg, Block)() {
  return get_message_type_support_handle<my_cobot_interfaces::msg::Block>();
}
