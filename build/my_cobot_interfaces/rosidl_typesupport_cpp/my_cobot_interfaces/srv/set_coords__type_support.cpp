...
static const _SetCoords_Request_type_support_symbol_names_t _SetCoords_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_cobot_interfaces, srv, SetCoords_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_cobot_interfaces, srv, SetCoords_Request)),
  }
};
...
{
  return &::my_cobot_interfaces::srv::rosidl_typesupport_cpp::SetCoords_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, my_cobot_interfaces, srv, SetCoords_Request)() {
  return get_message_type_support_handle<my_cobot_interfaces::srv::SetCoords_Request>();
}
...
static const _SetCoords_Response_type_support_symbol_names_t _SetCoords_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_cobot_interfaces, srv, SetCoords_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_cobot_interfaces, srv, SetCoords_Response)),
  }
};
...
{
  return &::my_cobot_interfaces::srv::rosidl_typesupport_cpp::SetCoords_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, my_cobot_interfaces, srv, SetCoords_Response)() {
  return get_message_type_support_handle<my_cobot_interfaces::srv::SetCoords_Response>();
}
...
static const _SetCoords_type_support_symbol_names_t _SetCoords_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_cobot_interfaces, srv, SetCoords)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_cobot_interfaces, srv, SetCoords)),
  }
};
...
{
  return &::my_cobot_interfaces::srv::rosidl_typesupport_cpp::SetCoords_service_type_support_handle;
}
