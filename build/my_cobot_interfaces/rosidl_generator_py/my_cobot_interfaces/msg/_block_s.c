...
bool my_cobot_interfaces__msg__block__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("my_cobot_interfaces.msg._block.Block", full_classname_dest, 36) == 0);
  }
  my_cobot_interfaces__msg__Block * ros_message = _ros_message;
  {  // color
...
PyObject * my_cobot_interfaces__msg__block__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("my_cobot_interfaces.msg._block");
