...
#include "my_cobot_interfaces/srv/detail/set_coords__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const my_cobot_interfaces::srv::SetCoords_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_cobot_interfaces::srv::SetCoords_Request & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
...
{
  auto typed_message =
    static_cast<const my_cobot_interfaces::srv::SetCoords_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_cobot_interfaces::srv::SetCoords_Request *>(
    untyped_ros_message);
...
{
  return &my_cobot_interfaces::srv::typesupport_fastrtps_cpp::_SetCoords_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_cobot_interfaces, srv, SetCoords_Request)() {
  return &my_cobot_interfaces::srv::typesupport_fastrtps_cpp::_SetCoords_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_my_cobot_interfaces
cdr_serialize(
  const my_cobot_interfaces::srv::SetCoords_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_cobot_interfaces::srv::SetCoords_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
...
{
  auto typed_message =
    static_cast<const my_cobot_interfaces::srv::SetCoords_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<my_cobot_interfaces::srv::SetCoords_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &my_cobot_interfaces::srv::typesupport_fastrtps_cpp::_SetCoords_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_cobot_interfaces, srv, SetCoords_Response)() {
  return &my_cobot_interfaces::srv::typesupport_fastrtps_cpp::_SetCoords_Response__handle;
}
...
{
  return &my_cobot_interfaces::srv::typesupport_fastrtps_cpp::_SetCoords__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_cobot_interfaces, srv, SetCoords)() {
  return &my_cobot_interfaces::srv::typesupport_fastrtps_cpp::_SetCoords__handle;
}
