...
#include "my_cobot_interfaces/srv/detail/set_coords__rosidl_typesupport_fastrtps_c.h"
...
using _SetCoords_Request__ros_msg_type = my_cobot_interfaces__srv__SetCoords_Request;
...
size_t get_serialized_size_my_cobot_interfaces__srv__SetCoords_Request(
  const void * untyped_ros_message,
...
static uint32_t _SetCoords_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_cobot_interfaces__srv__SetCoords_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_cobot_interfaces
size_t max_serialized_size_my_cobot_interfaces__srv__SetCoords_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _SetCoords_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_cobot_interfaces__srv__SetCoords_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_cobot_interfaces, srv, SetCoords_Request)() {
...
using _SetCoords_Response__ros_msg_type = my_cobot_interfaces__srv__SetCoords_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_cobot_interfaces
size_t get_serialized_size_my_cobot_interfaces__srv__SetCoords_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetCoords_Response__ros_msg_type * ros_message = static_cast<const _SetCoords_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_my_cobot_interfaces__srv__SetCoords_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_cobot_interfaces
size_t max_serialized_size_my_cobot_interfaces__srv__SetCoords_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _SetCoords_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_cobot_interfaces__srv__SetCoords_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_cobot_interfaces, srv, SetCoords_Response)() {
...
// already included above
// #include "my_cobot_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "my_cobot_interfaces/srv/set_coords.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_cobot_interfaces, srv, SetCoords)() {
