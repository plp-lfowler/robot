...
static const _SetJointAngles_Request_type_support_symbol_names_t _SetJointAngles_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_cobot_interfaces, srv, SetJointAngles_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_cobot_interfaces, srv, SetJointAngles_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, my_cobot_interfaces, srv, SetJointAngles_Request)() {
  return &::my_cobot_interfaces::srv::rosidl_typesupport_c::SetJointAngles_Request_message_type_support_handle;
}
...
static const _SetJointAngles_Response_type_support_symbol_names_t _SetJointAngles_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_cobot_interfaces, srv, SetJointAngles_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_cobot_interfaces, srv, SetJointAngles_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, my_cobot_interfaces, srv, SetJointAngles_Response)() {
  return &::my_cobot_interfaces::srv::rosidl_typesupport_c::SetJointAngles_Response_message_type_support_handle;
}
...
static const _SetJointAngles_type_support_symbol_names_t _SetJointAngles_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_cobot_interfaces, srv, SetJointAngles)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_cobot_interfaces, srv, SetJointAngles)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, my_cobot_interfaces, srv, SetJointAngles)() {
  return &::my_cobot_interfaces::srv::rosidl_typesupport_c::SetJointAngles_service_type_support_handle;
}
