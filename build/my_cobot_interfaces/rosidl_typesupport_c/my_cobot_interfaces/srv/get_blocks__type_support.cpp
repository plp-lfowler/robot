...
static const _GetBlocks_Request_type_support_symbol_names_t _GetBlocks_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_cobot_interfaces, srv, GetBlocks_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_cobot_interfaces, srv, GetBlocks_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, my_cobot_interfaces, srv, GetBlocks_Request)() {
  return &::my_cobot_interfaces::srv::rosidl_typesupport_c::GetBlocks_Request_message_type_support_handle;
}
...
static const _GetBlocks_Response_type_support_symbol_names_t _GetBlocks_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_cobot_interfaces, srv, GetBlocks_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_cobot_interfaces, srv, GetBlocks_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, my_cobot_interfaces, srv, GetBlocks_Response)() {
  return &::my_cobot_interfaces::srv::rosidl_typesupport_c::GetBlocks_Response_message_type_support_handle;
}
...
static const _GetBlocks_type_support_symbol_names_t _GetBlocks_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_cobot_interfaces, srv, GetBlocks)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_cobot_interfaces, srv, GetBlocks)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, my_cobot_interfaces, srv, GetBlocks)() {
  return &::my_cobot_interfaces::srv::rosidl_typesupport_c::GetBlocks_service_type_support_handle;
}
