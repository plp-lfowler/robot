...
my_cobot_interfaces__srv__PlayPause_Request__create()
{
  ...
  my_cobot_interfaces__srv__PlayPause_Request * msg = (my_cobot_interfaces__srv__PlayPause_Request *)allocator.allocate(sizeof(my_cobot_interfaces__srv__PlayPause_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(my_cobot_interfaces__srv__PlayPause_Request));
  bool success = my_cobot_interfaces__srv__PlayPause_Request__init(msg);
  if (!success) {
...
my_cobot_interfaces__srv__PlayPause_Request__destroy(my_cobot_interfaces__srv__PlayPause_Request * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    my_cobot_interfaces__srv__PlayPause_Request__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
my_cobot_interfaces__srv__PlayPause_Request__Sequence__init(my_cobot_interfaces__srv__PlayPause_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_cobot_interfaces__srv__PlayPause_Request * data = NULL;

  if (size) {
    data = (my_cobot_interfaces__srv__PlayPause_Request *)allocator.zero_allocate(size, sizeof(my_cobot_interfaces__srv__PlayPause_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = my_cobot_interfaces__srv__PlayPause_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        my_cobot_interfaces__srv__PlayPause_Request__fini(&data[i - 1]);
      }
...
my_cobot_interfaces__srv__PlayPause_Request__Sequence__fini(my_cobot_interfaces__srv__PlayPause_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      my_cobot_interfaces__srv__PlayPause_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_cobot_interfaces__srv__PlayPause_Request__Sequence * array = (my_cobot_interfaces__srv__PlayPause_Request__Sequence *)allocator.allocate(sizeof(my_cobot_interfaces__srv__PlayPause_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = my_cobot_interfaces__srv__PlayPause_Request__Sequence__init(array, size);
  if (!success) {
...
my_cobot_interfaces__srv__PlayPause_Request__Sequence__destroy(my_cobot_interfaces__srv__PlayPause_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    my_cobot_interfaces__srv__PlayPause_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
my_cobot_interfaces__srv__PlayPause_Request__Sequence__are_equal(const my_cobot_interfaces__srv__PlayPause_Request__Sequence * lhs, const my_cobot_interfaces__srv__PlayPause_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!my_cobot_interfaces__srv__PlayPause_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  my_cobot_interfaces__srv__PlayPause_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(my_cobot_interfaces__srv__PlayPause_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    my_cobot_interfaces__srv__PlayPause_Request * data =
      (my_cobot_interfaces__srv__PlayPause_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!my_cobot_interfaces__srv__PlayPause_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          my_cobot_interfaces__srv__PlayPause_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!my_cobot_interfaces__srv__PlayPause_Request__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_cobot_interfaces__srv__PlayPause_Response * msg = (my_cobot_interfaces__srv__PlayPause_Response *)allocator.allocate(sizeof(my_cobot_interfaces__srv__PlayPause_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(my_cobot_interfaces__srv__PlayPause_Response));
  bool success = my_cobot_interfaces__srv__PlayPause_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
my_cobot_interfaces__srv__PlayPause_Response__destroy(my_cobot_interfaces__srv__PlayPause_Response * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    my_cobot_interfaces__srv__PlayPause_Response__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
my_cobot_interfaces__srv__PlayPause_Response__Sequence__init(my_cobot_interfaces__srv__PlayPause_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_cobot_interfaces__srv__PlayPause_Response * data = NULL;

  if (size) {
    data = (my_cobot_interfaces__srv__PlayPause_Response *)allocator.zero_allocate(size, sizeof(my_cobot_interfaces__srv__PlayPause_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = my_cobot_interfaces__srv__PlayPause_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        my_cobot_interfaces__srv__PlayPause_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
my_cobot_interfaces__srv__PlayPause_Response__Sequence__fini(my_cobot_interfaces__srv__PlayPause_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      my_cobot_interfaces__srv__PlayPause_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_cobot_interfaces__srv__PlayPause_Response__Sequence * array = (my_cobot_interfaces__srv__PlayPause_Response__Sequence *)allocator.allocate(sizeof(my_cobot_interfaces__srv__PlayPause_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = my_cobot_interfaces__srv__PlayPause_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
my_cobot_interfaces__srv__PlayPause_Response__Sequence__destroy(my_cobot_interfaces__srv__PlayPause_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    my_cobot_interfaces__srv__PlayPause_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
my_cobot_interfaces__srv__PlayPause_Response__Sequence__are_equal(const my_cobot_interfaces__srv__PlayPause_Response__Sequence * lhs, const my_cobot_interfaces__srv__PlayPause_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!my_cobot_interfaces__srv__PlayPause_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  my_cobot_interfaces__srv__PlayPause_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(my_cobot_interfaces__srv__PlayPause_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    my_cobot_interfaces__srv__PlayPause_Response * data =
      (my_cobot_interfaces__srv__PlayPause_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!my_cobot_interfaces__srv__PlayPause_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          my_cobot_interfaces__srv__PlayPause_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!my_cobot_interfaces__srv__PlayPause_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
